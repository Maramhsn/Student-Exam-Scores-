...
Project Overview
This project analyzes student exam scores by examining various factors such as study hours, attendance percentage, and previous performance. The primary goal is to filter students based on their results (Pass/Fail), explore the correlation between study habits and academic success, and generate clean, exported datasets for further use.
Implementation
